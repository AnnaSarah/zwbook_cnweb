        ...
        <div class="container mt-5">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                ...
                                $result = $conn->query("SELECT id_category FROM category;");
                                
                                while  ($row = $result->fetch_assoc()){

                                   echo '<option value="'.$row['id_category'].'">'.$row['id_category'].'</option>';
            ...
            <?php
                if(isset($_GET['submit']) && $_GET['submit'] !==NULL){
                    ...
                    $get_last_id = "select max(ID_Book)+1 as id_last from book;";
                    if($result = $conn->query($get_last_id)){
                    ...
                    //echo "id last : ".$get_last_id;
                    $sql ="INSERT INTO `book`(`ID_Book`, `ID_Category`, `Name_Book`, `Cost`, `Link`) 
                            VALUES ('$id_new','$type','$name','$cost','$link')";
